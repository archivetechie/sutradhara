...
def o_archive_policy() -> RepresentationPolicy:
    ...
    return {
        ("o-archive", "o-copy-1"): Representation.REM_OBJECT_V1.value,
        ("o-archive", "o-copy-2"): Representation.REM_ENCRYPT_V1.value,
    }
...
def n_archive_policy() -> RepresentationPolicy:
    ...
    return {
        ("n-archive", "copy-1"): Representation.REM_OBJECT_V1.value,
        ("n-archive", "copy-2"): Representation.REM_ENCRYPT_V1.value,
